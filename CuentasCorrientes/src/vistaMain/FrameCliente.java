...
public class FrameCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setBorder(null);
        setPreferredSize(new java.awt.Dimension(970, 466));
        ...
        btnInsertaCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIOLETA/antialiasing_rendering2.png"))); // NOI18N
        ...
        btnInsertaCliente.setPressedIcon(new javax.swing.ImageIcon("/home/ferc/NetBeansProjects/CtaCorrientes/CuentasCorrientes/src/iconosMaxi/auto_correct.png")); // NOI18N
        btnInsertaCliente.setRequestFocusEnabled(false);
        btnInsertaCliente.setRolloverEnabled(false);
        laminaCliente.add(btnInsertaCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 290, 210, 50));
        ...
        laminaCliente.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 0, 1020, 70));
        ...
        getContentPane().add(laminaCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 972, 450));
