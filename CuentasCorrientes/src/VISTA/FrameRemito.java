...
public class FrameRemito extends javax.swing.JInternalFrame {
  ...
  //  JWebBrowser navergador = new JWebBrowser();
    ...
    private void initComponents() {
        ...
        laminaClienteRemitosGenerales.add(ComboObra, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 100, 170, 30));

        jLabel1.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 44, 103));
        jLabel1.setText("Num.R");
        laminaClienteRemitosGenerales.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, 30));
        ...
        laminaClienteRemitosGenerales.add(txtNumRemito, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 170, 40));

        jLabel3.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(102, 44, 103));
        jLabel3.setText("Fecha");
        laminaClienteRemitosGenerales.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 40, 60, -1));

        jLabel4.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 44, 103));
        jLabel4.setText("Obra");
        laminaClienteRemitosGenerales.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 100, 50, -1));

        jLabel5.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(102, 44, 103));
        jLabel5.setText("Buscar");
        laminaClienteRemitosGenerales.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, -1, -1));

        jLabel6.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(102, 44, 103));
        jLabel6.setText("Cliente");
        laminaClienteRemitosGenerales.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, -1, -1));
        ...
        laminaClienteRemitosGenerales.add(ComboClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 170, 30));
        ...
        laminaClienteRemitosGenerales.add(btnSubirRemito, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 30, 60, 40));
        ...
        radioObra.setForeground(new java.awt.Color(102, 44, 103));
        radioObra.setText("Obra");
        laminaClienteRemitosGenerales.add(radioObra, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 80, -1));
        ...
        radioCliente.setForeground(new java.awt.Color(102, 44, 103));
        radioCliente.setSelected(true);
        radioCliente.setText("Cliente");
        laminaClienteRemitosGenerales.add(radioCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 70, -1));
        ...
        laminaClienteRemitosGenerales.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 810, 240));

        jLabel11.setFont(new java.awt.Font("Decker", 0, 18)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(102, 44, 103));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel11.setText("Importe");
        laminaClienteRemitosGenerales.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 50, -1, -1));

        checkbox.setBackground(new java.awt.Color(0, 0, 16));
        checkbox.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        checkbox.setForeground(new java.awt.Color(102, 44, 103));
        checkbox.setText("Cierre cuenta");
        laminaClienteRemitosGenerales.add(checkbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, -1));
        laminaClienteRemitosGenerales.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 130, 170, 10));
        laminaClienteRemitosGenerales.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 170, 10));
        laminaClienteRemitosGenerales.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 70, 170, 10));
        laminaClienteRemitosGenerales.add(txtImporteRemito, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 40, 170, 30));
        laminaClienteRemitosGenerales.add(JDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 40, 170, 30));
        laminaClienteRemitosGenerales.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 170, -1));
        laminaClienteRemitosGenerales.add(txtBuscarRemito, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, 170, 30));
